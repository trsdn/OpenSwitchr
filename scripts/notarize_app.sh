...
if [[ -n "${NOTARY_PROFILE:-}" ]]; then
  ...
  if [[ "${#missing[@]}" -gt 0 ]]; then
    echo "Set NOTARY_PROFILE or provide APPLE_ID APPLE_TEAM_ID APPLE_APP_PASSWORD." >&2
    exit 1
  fi
